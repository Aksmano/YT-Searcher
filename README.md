...
> **Important:** After cloning this repo you have to create `.env` file where you will store your Google API Key. The file should be add in the main app folder. After that add a following line:
